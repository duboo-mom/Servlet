    ...
    pageEncoding="UTF-8"%>
		<nav class="main-menu bg-danger">
			<ul class="nav justify-content-around align-items-center">
				...
				<li class="nav-item"><a class="nav-link text-white" href="/jspTemplete/test01/test01.jsp?category=영화">영화</a></li>
				<li class="nav-item"><a class="nav-link text-white" href="/jspTemplete/test01/test01.jsp?category=스포츠">스포츠</a></li>
			</ul>
		</nav>